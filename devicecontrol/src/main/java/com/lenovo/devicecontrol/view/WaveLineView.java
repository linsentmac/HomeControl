package com.lenovo.devicecontrol.view;
...
public class WaveLineView extends View {
    ...
    public WaveLineView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        waveLineFirstWidth = 8;//第一条线的宽度，即粗细
        waveLineSecondWidth = 5;//第二条线的宽度，即粗细

        waveFirstAmplifier = 30.0f;//第一条线的振幅
        waveSecondAmplifier = 15.0f;//第二条线的振幅

        waveFirstPhase = 45.0f;//第一条线的相位，初始X轴偏移
        waveSecondPhase = 45.0f;//第二条线的相位，初始X轴偏移

        waveFirstFrequency = 1.8f;//第一条线的频率，可改变波长
        waveSecondFrequency = 2.0f;//第二条线的频率，可改变波长
